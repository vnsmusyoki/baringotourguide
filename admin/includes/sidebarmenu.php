<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Tour Accomodations</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="create-accomodation.php">Create</a></li>
					<li id="menu-academico-avaliacoes"><a href="manage-packages.php">Manage</a></li>
				</ul>
			</li>
			...
			<li><a href="manage-bookings.php"><i class="fa fa-list" aria-hidden="true"></i> <span>Manage Package Booking</span>
					<div class="clearfix"></div>
				</a></li>
			<li><a href="manage-accomodation-bookings.php"><i class="fa fa-list" aria-hidden="true"></i> <span>Manage Acc. Bookings</span>
					<div class="clearfix"></div>
				</a></li>
