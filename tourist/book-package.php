        ...
        <div class="page-container">
            ...
            <div class="left-content">
                ...
                <div class="row">
                    ...
                    $sql = "SELECT * from `tbltourpackages` WHERE `PackageId`='$bpack'";
                    ...
                    ?>
                            <div class="col-lg-12">
                                <div class="card">
                                    <img src="../admin/packageimages/<?php echo $image; ?>" alt="Card image cap" class="img-fluid">
                                    <div class="card-body" style="padding:1rem">
                                        ...
                                        <a href="package-details-old.php?pid=<?php echo $packageid; ?>" class="btn btn-primary">Book Now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Nearby Accomodations</li>
                </ol>
                <div class="row">
                    ...
                    $conn = mysqli_connect('localhost', 'root', '', 'tms');
                    $packagechecked = $_GET['package'];
                    $sql = "SELECT * from `tblaccomodations` WHERE `packageid`='$packagechecked'";
                    $query = mysqli_query($conn, $sql);
                    $rows = mysqli_num_rows($query);
                    if ($rows >= 1) {
                        $cnt = 1;
