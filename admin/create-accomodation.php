            ...
            if (in_array($fileActualExt, $allowed)) {
                if ($fileerror === 0) {
                    if ($filesize > 10000000) {
                        ...
                        $add = "INSERT INTO `tblaccomodations`(`name`, `price`, `packageid`, `picture`, `description`) VALUES ('$name', '$price','$destination','$filenamenew','$description')";
...
?>
    ...
    <head>
        <title>TMS | Admin Accomodation Creation</title>
                            ...
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="accomodation" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="name" id="name" placeholder="Create Accomodation" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control1" name="price" id="price" placeholder="Price per Night in  ksh" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" rows="5" cols="50" name="description" id="description" placeholder="Accomodation Details" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8 col-sm-offset-2">
                                            <button type="submit" name="submit" class="btn-danger btn">Create New Accomodation</button>
